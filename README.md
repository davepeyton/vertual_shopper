...
| User Story  #              | As a                 | I want to be able to...                             | So I can...                                |
| -------------------------- | -------------------- | --------------------------------------------------- | ----------------------------------------------- |
|                            |                      | Viewing and Site Navigation.                        |                                                 |
| 1                          | Visitor              | View product images.                                |                                                 |
...
| 9                          | Visitor              | Sort comics by the graphic novels, and new arrivals | Find available items from a system search.             |
|                            |                      | I am interested in.                                 |                                                 |
| 10                         | Visitor              | Sort items by faction and subfaction.               | Find a specific products.              |
| 11                         | Visitor              | Easily see what user has searched for and view the  |                                                 |
|                            |                                  results.                                  |                                                 |
...
| 17                         | Owner                | Add , buy , sell products.                          | Extend the range of items provided.             |
| 18                         | Owner                | Edit/update   items, products.                      | Change item, project info, images etc.          |
...
- **Buttons**
    - Clear interactive buttons when finished using them.
...
- The images on the homepage  are from []() & []()

- The gallery images come from various retailers most of on []()
